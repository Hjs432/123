...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <h3 class="section-title">推荐信息 [缴费专区]</h3>
            <ul class="info-list">
                <c:forEach items="${paidInfos}" var="info" begin="0" end="4">
                    <li><span class="info-tag">[${info.categoryName}]</span><a href="info/detail?id=${info.id}">${info.title}</a></li>
                </c:forEach>
            </ul>
            ...
            <div class="split-section">
                <div>
                    <h3>最新信息 [免费专区]</h3>
                    <ul class="info-list">
                        <c:forEach items="${freeInfos}" var="info" begin="0" end="4">
                            <li><span class="info-tag">[${info.categoryName}]</span><a href="info/detail?id=${info.id}">${info.title}</a></li>
                        </c:forEach>
                    </ul>
                    <a href="#" style="float: right; font-size: 12px; color: #2980b9;">更多...</a>
                </div>
                <div>
                    <h3>求职信息</h3>
                    <ul class="info-list">
                        <c:forEach items="${freeInfos}" var="info" begin="5" end="9">
                            <li><span class="info-tag">[${info.categoryName}]</span><a href="info/detail?id=${info.id}">${info.title}</a></li>
                        </c:forEach>
                    </ul>
                    <a href="#" style="float: right; font-size: 12px; color: #2980b9;">更多...</a>
